...
import com.winterframework.spring.web.servlet.handler.RestErrorConverter;
 ...
 * {@link com.winterframework.spring.web.servlet.handler.RestError#getStatus()
 * status} value.</li>
...
public class RestExceptionHandler extends AbstractHandlerExceptionResolver
	...
	protected ModelAndView doResolveException(HttpServletRequest request,
		...
		Response error = resolver.resolveError(request, handler, ex);
		if (error == null) {
			return null;
		}
	...
	protected ModelAndView getModelAndView(ServletWebRequest webRequest,
			Object handler, Response error) throws Exception {

		//applyStatusIfPossible(webRequest, error);

		//String body=JsonMapper.nonEmptyMapper().toJson(error);
	...
	private ModelAndView handleResponseBody(Object body,
		...
		if (log.isWarnEnabled()) {
			log.warn("Could not find HttpMessageConverter that supports return type ["
